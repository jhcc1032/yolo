	...
	<form method="post" action="updateMember.do" id="frm" name="frm">
		<table align='center'>
			...
			<tr>
				...
				<td class='tbasic'><input type='hidden' name='id'
			...
			<tr>
				<td colspan='2' align='center' class='tfoot tspacial'><input
					type="button" onclick="Javascript:button_event();" value='수정'>
